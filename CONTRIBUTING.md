# Contributing to termharness

We welcome contributions to "termharness" and greatly appreciate your help in making
...
[termharness repository](https://github.com/ynqa/termharness) to create a copy of the
...
```bash
git clone https://github.com/<your_username>/termharness.git
```
...
[termharness Pull Request page](https://github.com/ynqa/termharness/pulls) and click the
...
Thank you for considering contributing to "termharness"!
